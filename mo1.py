...
a = '016c8259007f4b80a059d0bcb6b9a3cc'
...
'''
data = f'from=en&to=zh&query=spider&transtype=realtime&simple_means_flag=3&sign=63766.268839&token={a}=&domain=common'  # 这里的f指的是fromat中的格式化

...
# url的组成 协议 两种http\https   主机 就是网站的域名或者是ip地址       端口号 http:80 https:443    mysql:3306  oracle:1521  redis 6379
# mongodb:27017   路径(是s或者是参数前的也就是问号前的)  参数(问号后面填入的)  锚点 https 更加安全 其中加入了ssl的证书验证
...
# 实际在使用request模块时也是不能将headers的请求头字典直接放在参数中
ua = {
